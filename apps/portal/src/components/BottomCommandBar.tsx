  ...
  return (
    <div className="border-t border-gray-200 bg-white">
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        {/* Attachment buttons */}
        <div className="flex gap-1">
          <button className="p-1.5 rounded hover:bg-gray-100 text-gray-400" title="上传文件">
            <Paperclip size={18} />
          </button>
          <button className="p-1.5 rounded hover:bg-gray-100 text-gray-400" title="截图">
            <Image size={18} />
          </button>
          <button className="p-1.5 rounded hover:bg-gray-100 text-gray-400" title="语音">
            <Mic size={18} />
          </button>
        </div>
