  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-light relative">
      ...
      <div className="login-card relative z-10 animate-in-up">
        ...
        <p className="text-base text-text-tertiary text-center mb-8">Ample AI Native OS</p>
        ...
        <p className="text-base text-text-tertiary text-center mt-6">演示账号: admin / sales1 / proc1 / risk1</p>
      </div>
    </div>
  );
}
