  ...
  return (
    <WorkspaceLayout
      ...
      topBarChildren={
        <div className="flex items-center gap-2 ml-6">
          ...
          <button className="px-3 py-1.5 text-lg rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors">本周</button>
          <button className="px-3 py-1.5 text-lg rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors">本月</button>
        </div>
      }
      rightPanel={
        <div className="p-4 space-y-5">
          ...
          <div className="proto-card p-4">
            <h3 className="text-lg font-semibold text-gray-400 uppercase tracking-wide mb-3">供需匹配</h3>
    ...
    >
      <div className="p-6 space-y-6">
        ...
        {/* 动态流 */}
        <div>
          <h2 className="text-lg font-semibold text-gray-400 uppercase tracking-wide mb-3">动态流</h2>
          <div className="space-y-3">
            {feed.map((item, i) => (
              <div key={i} className="proto-card p-4 flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg text-gray-400">{item.time}</span>
                  </div>
                  <p className="text-lg text-gray-500 mt-0.5">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* Agent 建议 */}
        <div>
          <h2 className="text-lg font-semibold text-gray-400 uppercase tracking-wide mb-3">Agent 建议</h2>
